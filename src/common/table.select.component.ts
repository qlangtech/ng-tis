        ...
        <div class="container">
            ...
            <div>
                <button class="assist-btn" nz-button
                        nzSize="small" nzType="link" (click)="addDataSource()"><i nz-icon [nzType]="'setting'"
                                                                                  [nzTheme]="'outline'"></i>数据源
                </button>
            </div>
        </div>
...
export class TableSelectComponent extends BasicFormComponent implements OnInit, AfterViewInit, ControlValueAccessor {
    ...
    manageDbTable(opt: NzCascaderOption, e: MouseEvent): void {
        ...
        // db
        DatasourceComponent.openAddTableForDataSourceDialog(this, db).then((r: SuccessAddedDBTabs) => {
