            ...
            <tis-col title="处理器" width="35">
                <ng-template let-u='r'>
                    <div [ngClass]="{'ant-form-item-has-error':!!u.udfError}">
                        <tis-plugin-add-btn [disabled]="this.readonly" [ngClass]="{'ant-input':!!u.udfError}"
                                            [btnSize]="'small'"
                ...
                <ng-template let-u='r'>
                    <div class="item-block item-block-absolute" *ngIf="u.udfDescLiteria">
                        ...
                        <div *ngIf="!readonly" class="absolute-btn-element">
                            <button nz-button nzType="default" (click)="updateTransformerRule(u)" nzSize="small"><span
                                    nz-icon
                                    nzType="edit"
        ...
        let p = new Promise<{ item: Item, descLiteria: Array<UdfDesc> }>(function (resolve, reject) {
            try {
                ...
                PluginsComponent.openPluginDialog({
                    ...
                    , basicCpt, desc
                    , {
                        name: 'noStore', require: true, descFilter: {
                ...
                console.error('Error in openPluginDialog:', error);
                reject(error);
            }
        });
