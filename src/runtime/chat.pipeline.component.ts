          ...
          <div class="messages-container" #messagesContainer>
            <div *ngFor="let msg of currentMessages" class="message" [ngClass]="'message-' + msg.role">
              ...
              <div class="message-content">
                <div *ngIf="msg.type === 'text'" class="message-text" [innerHTML]="formatMessage(msg.content)"></div>
                ...
                <div *ngIf="msg.type === 'progress'" class="message-progress">
                  <nz-progress [nzPercent]="getProgressPercent(msg.content)" nzStatus="active"></nz-progress>
                ...
                <div *ngIf="msg.type === 'selection'" class="message-selection">
                  ...
                  <nz-radio-group [(ngModel)]="msg.selectionData['selectedIndex']" class="selection-options">
...
export class ChatPipelineComponent extends BasicFormComponent implements OnInit, OnDestroy {
  ...
  private connectSSE(userInput: string): void {
    const url = `/coredefine/corenodemanage.ajax?action=chat_pipeline_action&emethod=chat` +
      `&sessionId=${this.currentSessionId}&input=${encodeURIComponent(userInput)}`;
    ...
    this.eventSource.addEventListener('plugin', (event: MessageEvent) => {
      const data = JSON.parse(event.data);
    ...
    this.eventSource.addEventListener('selection_request', (event: MessageEvent) => {
      const data = JSON.parse(event.data);
