          ...
          <div nz-row [nzGutter]="8">
            ...
            <div nz-col nzSpan="8">
              <nz-card id="dataflow" [nzHoverable]="true" (click)="routerTo('/offline/wf')">
                <div class="tis-card-content">
                  <div class="compose">
                    <h1>
                      <nz-badge [nzCount]="5" nzDot><i nz-icon nzType="branches"
                                                       nzTheme="outline"></i></nz-badge>
                      数据流
                    </h1>
            ...
            <div nz-col nzSpan="8">
              <nz-card [nzHoverable]="true" (click)="routerTo('/base/plugin-manage')">
                <div class="tis-card-content">
                  <div class="compose">
                    <h1><i nz-icon nzType="api" nzTheme="outline"></i>插件市场</h1>
          ...
          <div nz-col nzSpan="8">
            <nz-card nzTitle="相关">
              <nz-descriptions [nzColumn]="1">
                <nz-descriptions-item [nzTitle]="githubRef">
                  <a target="_blank"
